package com.ddd.attendance.core.ui.theme
...
val DDD_300 = Color(color = 0xFF8F8F8F)
val DDD_200 = Color(color = 0xFFE6E6E6)
val DDD_WHITE = Color(color = 0xFFFFFFFF)
val DDD_ERROR = Color(color = 0xFFFD1008)
